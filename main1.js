...
let cel = Number.parseFloat(prompt("Введите тумпературу в градусах по цельсию: - >"));
let foringeit = (9 / 5) * cel + 32;
alert(`Цельсий: ${Math.round(cel)}, Фаренгейт: ${Math.round(foringeit)}`);